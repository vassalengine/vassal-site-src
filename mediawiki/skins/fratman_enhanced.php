 ...
 * @subpackage Skins
 */
class Skinfratman_enhanced extends SkinTemplate {
	/** Using fratman_enhanced. */
	function initPage( &$out ) {
		SkinTemplate::initPage( $out );
		$this->skinname  = 'fratman_enhanced';
		$this->stylename = 'fratman_enhanced';
		$this->template  = 'fratman_enhancedTemplate';
	}
}
 ...
 * @subpackage Skins
 */
class fratman_enhancedTemplate extends QuickTemplate {
	/**
	 * Template filter callback for fratman_enhanced skin.
